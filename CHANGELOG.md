...
## [2.17.0](https://github.com/djsaikrishna/aiometadata/compare/v2.16.5...v2.17.0) (2026-09-02)
...
* add per-type controls for watch tracking ([5f2f559](https://github.com/djsaikrishna/aiometadata/commit/5f2f55970488d452d498196b3df64f82e851d936))
...
* add trigger keyword to AI search ([a64097f](https://github.com/djsaikrishna/aiometadata/commit/a64097f5780896fb8adf1dd401e5597a2013d8e8))
* add trigger keyword to AI search ([3231795](https://github.com/djsaikrishna/aiometadata/commit/32317953bb39dd454a722a07c462dd4535899d5b))
...
* experimental aiom image caching engine ([67f33e7](https://github.com/djsaikrishna/aiometadata/commit/67f33e76aac52f927deb219c971e19008df43772))
...
* **movielens:** apply taste tags on non-prediction catalog sorts ([2a12df2](https://github.com/djsaikrishna/aiometadata/commit/2a12df2e333f072e9ce6f2d386c7adb967a899bc))
...
* **movielens:** import user-created lists as catalogs ([828bd07](https://github.com/djsaikrishna/aiometadata/commit/828bd078b105674f37e6154a44f06700e69de243))
* **movielens:** multi-user MovieLens recommendations ([fad8105](https://github.com/djsaikrishna/aiometadata/commit/fad8105a7b2dcdc8dd70f1c19c028a120d455b1e))
...
* **top10:** broaden service coverage, handle regional variants ([fbe5d75](https://github.com/djsaikrishna/aiometadata/commit/fbe5d7559bb7f89c5e33d0cd0241e69038219895))
* **top10:** broaden service coverage, handle regional variants ([a1ed440](https://github.com/djsaikrishna/aiometadata/commit/a1ed4404784b0ddb1e48de74712416a762af872b))
...
* **cache:** match catalog TTL override by id and type ([8ea6b91](https://github.com/djsaikrishna/aiometadata/commit/8ea6b91171826bc754cfe2f5f37af35ec3c97514))
...
* **cache:** refresh catalogs from their source instead of cache ([b4616be](https://github.com/djsaikrishna/aiometadata/commit/b4616bef6f168f034007a8defa863f21b2991887))
* **cache:** refresh series metadata once an upcoming episode has aired ([a8ffdc6](https://github.com/djsaikrishna/aiometadata/commit/a8ffdc6a93185e402e6b1e79ac709d948672b6be))
...
* **catalogs:** allow hiding unreleased shows per catalog ([3dfca7e](https://github.com/djsaikrishna/aiometadata/commit/3dfca7efacd2fc34c77a3d704f353cbe9d543c5b))
...
* **catalogs:** render only the catalog rows in view ([ec2662b](https://github.com/djsaikrishna/aiometadata/commit/ec2662b5cf81547967a60a5e3201fcc2978a2ea5))
* **catalogs:** request media type for split MDBList watchlists ([0b2fbcc](https://github.com/djsaikrishna/aiometadata/commit/0b2fbccdae671fbdbc1da45711b0c7c6939f84e6)), closes [#687](https://github.com/djsaikrishna/aiometadata/issues/687)
...
* **collections:** rebuild TMDB collection sources on import ([491a5c7](https://github.com/djsaikrishna/aiometadata/commit/491a5c74a0d1e1ca1e5cb0512d40c231122209c1))
...
* **config:** keep a large configuration savable ([a133856](https://github.com/djsaikrishna/aiometadata/commit/a13385697de5e01081aef682f03342cdd5f56d40))
...
* hydrate release dates on TVDB movie search results so the digital release filter can act on them ([fa533b2](https://github.com/djsaikrishna/aiometadata/commit/fa533b26ac23f87380a7bb65641e74a1df3cf943))
...
* **logo:** cache metahub image-existence checks for the full TTL ([e679561](https://github.com/djsaikrishna/aiometadata/commit/e67956105380ea64d292f48137469f8005c18cb1))
* **logo:** verify metahub logo fallbacks exist before serving them ([44f90de](https://github.com/djsaikrishna/aiometadata/commit/44f90deafc4684a122fda72c31a3e8156c123324))
...
* **meta:** emit director and writer as string arrays per the Stremio spec ([8d90666](https://github.com/djsaikrishna/aiometadata/commit/8d9066631688e704ec88fca63be2e85ba3f970bc))
* **meta:** emit director and writer as string arrays per the Stremio spec ([ceb7b9c](https://github.com/djsaikrishna/aiometadata/commit/ceb7b9c5b5b89f9fa5c8d385bf9e5f7b3cbbe096))
...
* **meta:** read cached credits as arrays ([bafec6e](https://github.com/djsaikrishna/aiometadata/commit/bafec6e86a44455bc9e377baa2c50921c07dee14))
...
* paginate Trakt watched fetches and prioritize recently aired shows in unwatched catalog ([415725f](https://github.com/djsaikrishna/aiometadata/commit/415725fb75343839602aac0c9eca8a31c313a6f3))
...
* request Trakt watched shows with extended=progress so hide-watched works again ([963dd96](https://github.com/djsaikrishna/aiometadata/commit/963dd9647d590d915f1d7546f7abd301ec7909dc))
...
* stop inferring a rating poster provider from saved API keys ([a7a2359](https://github.com/djsaikrishna/aiometadata/commit/a7a2359069361d7b732746cac26f6de44c83c33d))
